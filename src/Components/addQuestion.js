...
export default function AddQuestion(){
    ...
    const currentQuestions = yourQuestion.slice(indexOfFirstQuestion,indexOfLastQuestion);
    ...
    const handleQuestionDetele =(e, questionId, question) => {
        ...
        const url = 'https://floating-badlands-28885.herokuapp.com/Question/' + questionId
                    ...
                    <div className="filterArea">
                        ...
                        <Form  onSubmit ={onFormSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Label for="Dificulty" lg={1} md={12} sm={12}><b>Dificulty Level</b></Label>
                                <Col lg={5} md={12} sm={12}>
                            ...
                            <FormGroup row>
                                <Col sm={12}>
                                    <Button type='submit' size="lg" block disabled={busyBtn}>Submit</Button>
                                </Col>
                            </FormGroup>
                        </Form>
                    </div>
                        ...
                        <div className="question-render">
                            ...
                            <Col lg={6} md={12} sm={12} key={index}>
                                <Card key={index} style={{ width: '100%' , marginBottom:"30px"}}>
                                    <Card.Header>
                                        <h6 className="quiz-title"><b>Q{(currentPage-1)*questionPerPage+index+1}.</b> {eachQuestion.question}</h6>
                                    </Card.Header>
                                    <Card.Body>
                                        <Row>
                                            <Col lg={6} md={12} sm={12}>
                                                <Chip style={{width: '100%' ,marginBottom:"10px"}} label={eachQuestion.option1} />
                                                <Chip style={{width: '100%' ,marginBottom:"10px"}} label={eachQuestion.option2} />
                                            </Col>
                                            <Col lg={6} md={12} sm={12}>
                                                <Chip style={{width: '100%' ,marginBottom:"10px"}} label={eachQuestion.option3} />
                                                <Chip style={{width: '100%' ,marginBottom:"10px"}}label={eachQuestion.option4} />
                                            </Col>
                                            <Col sm={12} className="delete-icon">
                                                <i><FontAwesomeIcon icon={faTrash} onClick={(e) => handleQuestionDetele(e, eachQuestion._id, eachQuestion)}/></i>
                                            </Col>
                                        </Row>
                                    </Card.Body>
                                </Card>
                            ...
                            <Row className="justify-content-md-center">
                                <Pagination count={Math.ceil(yourQuestion.length/questionPerPage)} showFirstButton showLastButton onChange={handlePageChange}/>
                            </Row>
                        </div>
                        }
                    </div>
