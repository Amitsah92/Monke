  ...
  const onFormSubmit = (e) => {
    ...
    if (
      (data.get("username") !== null &&
        user.loggedUser !== data.get("username")) ||
        ...
        <form className="form-dashboard" onSubmit={onFormSubmit}>
          ...
          <Row>
            ...
            <Col sm={12} className="usernameedit-col">
              <input
                className={unEdit ? "test-input-active" : "test-input"}
                type="text"
                name="username"
                id="Username"
                autoComplete="off"
            ...
            <Col sm={12} className="email-col">
              <input
                className={mailEdit ? "test-input-active" : "test-input"}
                type="text"
                name="email"
                id="Email"
                autoComplete="off"
            ...
            <Col sm={12}>
              {(unEdit || mailEdit) && !pwEdit ? (
                <Button type="submit" variant="success" className="button-save">
                  Save
                </Button>
              ) : (
                <div></div>
