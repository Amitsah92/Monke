...
const columns = [
    ...
    { id: 'totalQuestion', label: 'Total Question', minWidth: 100,align: 'center'},
...
export default function QuizResultTable(quizId){
    ...
    useEffect(() =>{
        ...
        axios.post('https://floating-badlands-28885.herokuapp.com/player/findPlayer', quizId, header)
        .then(res => {
    ...
    return(
        <div>
            <Paper className={classes.root}>
                ...
                <TablePagination
                    rowsPerPageOptions={[5,10,15,20,25,30,40,50,60,70,80,90,100]}
                    component="div"
