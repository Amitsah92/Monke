          ...
          {loading ? (
            <Container>
                  ...
                  <Col lg={4} md={6} sm={12} key={index}>
                    ...
                    >
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>
                          Total number of Questions: <b>{quiz.noOfQuestion}</b>
                        </Card.Text>
                        <Button
                          variant="primary"
                          onClick={(e) => handleClick(quiz, e)}
                        >
                          Play Quiz
                        </Button>
                      </Card.Body>
                      <Card.Footer>
                        <small className="text-muted">
                          Expires in {expiresInDate(quiz.expiryDate)} Days.
                        </small>
                      </Card.Footer>
                    </Card>
                  </Col>
              ...
              <Row className="justify-content-md-center">
                <Pagination
                  count={Math.ceil(quizs.length / quizPerPage)}
                  showFirstButton
                  showLastButton
